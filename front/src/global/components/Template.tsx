...
type ComponentProps = Z.infer<typeof ComponentSchema>['component'];

const Template = ({ component: Component }: { component: ComponentProps }) => {
  try {
  ...
  return (
    <div className="relative flex items-center justify-center h-screen mx-auto my-auto">
      ...
      <div className="relative flex w-[clamp(0px,41.25%,792px)]">
        ...
        {/* 뒷 배경 영역 */}
        <div className="absolute flex flex-col top-[5px] left-[20px] z-[-1] w-full h-full">
