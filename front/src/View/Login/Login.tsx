    ...
    <div className="--root-flex">
      ...
      <div className="--primary-flex-col bg-statusColor-08 w-[39.48%] h-[75.83%] rounded-[36px]">
        ...
        <div className="flex flex-col" style={{ display: 'contents' }}>
          ...
          <div className="Pretendard semibold bg-primaryColor --primary-flex w-[84.43%] h-[11.23%] rounded-[30px] mb-[15px]">
            {/* w-[84.43%] h-[11.23%] rounded-[30px] */}
            나의 공장 들어가기
            <img src="#" alt="img" />
          </div>
          <div className="--font-xs Pretendard text-neutralColor mb-[45px]">
            <u>공장 열쇠를 잊어버렸나요?</u>
          </div>
          <div className="Pretendard semibold bg-statusColor-01 text-statusColor-08 --primary-flex w-[84.43%] h-[11.23%] rounded-[30px] mb-[15px]">
            공장 새로 만들기
          </div>
          <div className="--font-xs Pretendard text-neutralColor">
